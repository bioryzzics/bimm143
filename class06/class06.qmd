...
To use the `apply()` function on this `gradebook` dataset I need to decide wheter I want to "apply" the `grade()` function over the rows (1) or columns (2) of the `gradebook`
...
I could mofidy the `grade()` function to do this too - i.e. not drop the lowest options
